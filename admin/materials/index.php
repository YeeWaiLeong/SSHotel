...
<script>
	...
	$(document).ready(function(){
		$('.new_client').click(function(){
			location.href = _base_url_+"admin/?page=materials/manage";
		})
		$('.manage_client').click(function(){
			location.href = _base_url_+"admin/?page=materials/manage&id="+$(this).attr('data-id')
		})
		$('.delete_client').click(function(){
		_conf("Are you sure to delete this material?","delete_client",[$(this).attr('data-id')])
		})
		$('#list').dataTable()
	})
