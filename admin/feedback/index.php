			...
			<table class="table tabe-hover table-bordered table-compact" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<small class=""><b>Department:</b> <?php echo $row['subject'] ?></small><br>
...
<script>
	...
	$(document).ready(function(){
		$('.view_message').click(function(){
			...
			uni_modal("Feedback Content","feedback/view.php?&id="+$(this).attr('data-id'))
		})
		$('.delete_message').click(function(){
		_conf("Are you sure to delete this feedback?","delete_message",[$(this).attr('data-id')])
		})
		$('#list').dataTable()
	})
