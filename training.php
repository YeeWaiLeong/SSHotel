...
<body style="/*background: url(&quot;design.jpg&quot;);*/background-position: 0 -60px;">
    <nav class="navbar navbar-light navbar-expand-md sticky-top navbar-shrink py-3" id="mainNav" style="background: #8b8b8b;color: #ffffff;">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="home.html"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon" style="background: rgb(255,255,255);"><img src="/assets/img/SamaSamaHotelLogo1.png" width="27" height="27"></span><span style="color: rgba(255,255,255,0.9);">Sama Sama Hotel</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <footer class="bg-primary-gradient">
        <div class="container py-4 py-lg-5">
            ...
            <div class="text-muted d-flex justify-content-between align-items-center pt-3">
                <p class="mb-0">Copyright © 2022 Sama Sama Hotel</p>
            ...
            <div class="col-md-6 col-lg-5 col-xl-4" style="background: #8398c2;">
                <div></div>
            </div>
        </div>
    </footer>
